...
#' 
#' @rdname shinyTraitObject
#' @importFrom shiny NS uiOutput
#' @export
#'
shinyTraitObjectUI <- function(id) {
  ns <- shiny::NS(id)
...
#' @export
#'
shinyTraitObjectOutput <- function(id) {
  ns <- shiny::NS(id)
...
#' 
#' @importFrom shiny radioButtons reactive renderUI req
#' @importFrom DT renderDataTable
#' @export
#'

shinyTraitObject <- function(input, output, session,
